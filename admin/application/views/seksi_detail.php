                        ...
                        <div class="box-body">
                            ...
                            <div id="div1<?= $lu->ps_id ?>" style="display:none;">
                                ...
                                <div class="form-group row" id="<?= $rowId ?>">
                                    <input type="hidden" name="indexja[]" value="<?= $index; ?>">
                                    <?php if ($count == false) { ?>
                                        <label class="col-sm-2 control-label">Jawaban</label>
                                    <?php } else { ?>
                                ...
                                foreach ($listpertanyaan as $lu) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-sm btn-warning my-1" data-bs-toggle="modal" data-bs-target="#editSurvey<?= $lu->ps_id; ?>"><i class="fa fa-edit"></i> Edit</button> &nbsp;
                                            <button class="btn btn-sm btn-success my-1" data-bs-toggle="modal" data-bs-target="#duplikatSurvey<?= $lu->ps_id; ?>"><i class="fa fa-copy"></i> Duplikat</button>
                                            <button class="btn btn-sm btn-danger my-1" data-bs-toggle="modal" data-bs-target="#hapusSurvey<?= $lu->ps_id; ?>"><i class="fa fa-trash"></i> Hapus</button>
                                        </td>
                                    </tr>

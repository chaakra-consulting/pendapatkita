  ...
  <div class="user_options-container">
    <div class="user_options-text">
      <div class="user_options-unregistered div-logo">
        <div class="logo-smk">
          <img src="<?=base_url('assets/img/logo.png');?>" style="width: 75px; margin-right: 20px;">
          <h1>Pendapat Kita</h1>
        </div>
        <!-- <h2 class="user_unregistered-title">SMK N 1 Kedungwuni</h2> -->
        <p class="user_unregistered-text">Gunakan Username dan Passsword untuk masuk,</p>
    ...
    <div class="user_options-forms" id="user_options-forms">
      <div class="user_forms-login">
        ...
        <form class="form padding-b" action="<?=base_url('Login/actlogin');?>" method="POST">
  		    <input type="text" name="nis" placeholder="Username" autofocus required="" />
      ...
      <div class="user_forms-signup">
        ...
        <form class="form padding-b formnis">
          <input id="fnis" type="text" name="nis" placeholder="Username" required>
          <i class="fa fa-user"></i>
          <p class="error-redB">Username Tidak Ditemukan !</p>

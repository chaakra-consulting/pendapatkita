		...
		<div class="col-md-12 col-lg-12 col-xl-12">
			<div class="card card-table-two">
				<div class="d-flex justify-content-between">
					<h4 class="card-title mb-1">List Survey yang terpending</h4>
					<i class="mdi mdi-dots-horizontal text-gray"></i>
				</div>
				<?php if (count($survey) > 0) { ?>
					<span class="tx-12 tx-muted mb-3 ">Data Survey yang terpending</span>
								...
								?>
									...
									<tr>
										...
										<td style="text-align:center;">
											<a href="<?= base_url() ?>survey/<?= $ju->js_survey_id; ?>/<?= $ju->js_kodesurvey; ?>/<?= 'data'; ?>"><button class="btn btn-info" style="padding:2px;font-size:0.8em"><i class="fa fa-paper-plane"></i> Lanjutkan Survey</button></a>
										</td>

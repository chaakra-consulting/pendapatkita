        ...
        <div class="row align-items-center">
          ...
          <div class="col-6 col-md-6 col-xl-4 d-block">
            <h1 class="mb-0 site-logo">
              <img src="<?php echo base_url('assets2/images/logobaru.png') ?>" alt="">
            </h1>
          </div>

          <!-- Menu untuk DESKTOP -->
          <div class="col-12 col-md-6 col-xl-8 main-menu d-none d-lg-block">
          ...
          <!-- Menu khusus HP: hanya tombol Masuk -->

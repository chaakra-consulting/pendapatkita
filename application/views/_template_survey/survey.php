					...
					<form method="POST" name="surveying" id="surveying" action="<?= base_url() ?>user/surveysave/<?= $detil_survey->id_survey; ?>" enctype="multipart/form-data">
						<div class="panel-group1" id="accordion11">
										...
										<div class="row row-xs formgroup-wrapper">
											...
											<div class="col-md-6 ">
												...
												<div class="form-group">
													...
													<input type="text" name="pewawancara" class="form-control" placeholder="Pewawancara ..." value="<?= $this->session->nama; ?>" required>
												</div>
												<div class="form-group">
											...
											<div class="col-md-6">
												...
												<div class="form-group">
													...
													<input type="text" name="namaresponden" class="form-control" placeholder="Nama Responden ..." required>
												</div>
											</div>
										</div>
									</div>
							...
							?>
														...
														if ($ta->ps_tipe_pertanyaan == 1) {
															...
															foreach ($pilja as $pj) {
																if ($pj != '') {
																	...
																	$pakwar .= '<div class="checkbox"><label><input type="checkbox" name="' . $ta->ps_id . '[]" id="' . $ta->ps_id . '" value="' . $pillo[0] . '"> ' . $pillo[0] . ' ' . $lnk . '</label></div>';
																	$paklo = $pillo[1];
																}
															}
								...
								<label class="col-sm-1 form-control-static" id="' . $ta->ps_kode . '">' . $ta->ps_kode . '</label>
